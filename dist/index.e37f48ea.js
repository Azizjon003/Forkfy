...
var _recipView = require("./views/recipView");
var _recipViewDefault = parcelHelpers.interopDefault(_recipView);
...
const showRetcipe = async function() {
    try {
        ...
        if (!id) return;
        _recipViewDefault.default.spinner();
        await _model.loadRecipe(id);
        _recipViewDefault.default.render(_model.state.recipe);
    } catch (error) {
        alert(error);
    }
};
[
    'load',
    'hashchange'
].forEach((val)=>window.addEventListener(val, showRetcipe)
);
let funct = function() {
    return new _coreJs.Promise(function(resolve) {
        setTimeout(()=>{
...
},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21","./views/recipView":"8ULRL","core-js":"h5Izt"}],"dXNgZ":[function(require,module,exports) {
/**
...
const loadRecipe = async function(id) {
    try {
        const dataJSon = await _help.getJson(_config.APi_URL + id);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config":"k5Hzs","./help":"gaL6d"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gaL6d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ULRL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RetcipeView", ()=>RetcipeView
);
...
exports.default = new RetcipeView();
...
},{"../internals/function-bind-native":"i16Dq"}],"iZ18O":[function(require,module,exports) {
var classof = require('../internals/classof-raw');
...
},{"../internals/to-property-key":"5XWKd","../internals/object-define-property":"iJR4w","../internals/create-property-descriptor":"1lpav"}],"RsFXo":[function(require,module,exports) {
var uncurryThis = require('../internals/function-uncurry-this');
module.exports = uncurryThis([].slice);

},{"../internals/function-uncurry-this":"7GlkT"}],"9TrPc":[function(require,module,exports) {
var wellKnownSymbol = require('../internals/well-known-symbol');
...
},{"../internals/global":"i8HOC","../internals/a-callable":"gOMir","../internals/to-object":"5cb35","../internals/indexed-object":"kPk5h","../internals/length-of-array-like":"lY4mS"}],"2Jcp4":[function(require,module,exports) {
var classof = require('../internals/classof-raw');
var global = require('../internals/global');
...
},{"../internals/global":"i8HOC"}],"7jDg7":[function(require,module,exports) {
var global = require('../internals/global');
var apply = require('../internals/function-apply');
var bind = require('../internals/function-bind-context');
var isCallable = require('../internals/is-callable');
...
},{"../internals/export":"dIGt4","../internals/array-group-by":"Kk936","../internals/array-method-is-strict":"7oKGa","../internals/add-to-unscopables":"jx7ej"}],"Kk936":[function(require,module,exports) {
var global = require('../internals/global');
var bind = require('../internals/function-bind-context');
var uncurryThis = require('../internals/function-uncurry-this');
var IndexedObject = require('../internals/indexed-object');
...
},{"../internals/export":"dIGt4","../internals/get-built-in":"6ZUSY","../internals/function-bind-context":"7vpmS","../internals/function-uncurry-this":"7GlkT","../internals/indexed-object":"kPk5h","../internals/to-object":"5cb35","../internals/length-of-array-like":"lY4mS","../internals/array-method-is-strict":"7oKGa","../internals/add-to-unscopables":"jx7ej"}],"9Kgew":[function(require,module,exports) {
var $ = require('../internals/export');
var isArray = require('../internals/is-array');
// eslint-disable-next-line es/no-object-isfrozen -- safe
var isFrozen = Object.isFrozen;
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/function-call":"d7JlP","../internals/an-object":"4isCr","../internals/a-callable":"gOMir"}],"kYZaO":[function(require,module,exports) {
'use strict';
// TODO: remove from `core-js@4`
var $ = require('../internals/export');
...
var FORCED = !isCallable(NativeObservable) || !isCallable(NativeObservable.from) || !isCallable(NativeObservable.of) || !isCallable(NativeObservablePrototype.subscribe) || !isCallable(NativeObservablePrototype[$$OBSERVABLE]);
...
},{"../internals/export":"dIGt4","../internals/function-call":"d7JlP"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire7e89")
